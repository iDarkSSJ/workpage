...
ALTER TABLE "featured_project" ADD CONSTRAINT "featured_project_freelancer_id_freelancer_profile_id_fk" FOREIGN KEY ("freelancer_id") REFERENCES "public"."freelancer_profile"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "featured_project_freelancer_idx" ON "featured_project" USING btree ("freelancer_id");--> statement-breakpoint
